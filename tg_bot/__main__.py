...
TECHNO_IMG = "https://static9.depositphotos.com/1245125/1192/v/950/depositphotos_11923759-stock-illustration-vector-illustration-of-beautiful-princess.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/myselfunforgettable")],
                                                                                   [InlineKeyboardButton(text="ADD SUNSHINE TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/thisisbabubihari/Sunshine")
                                                                                 ]]))

    else:
        update.effective_message.reply_text("Hello, I am Sunshine")
